...
//                        DisposedUtil.getInstance().addDisposable(d);
    ...
    public void getCheckHistory(String url, Map<String, String> param, IResponseCallBack callBack) {
        getObservable(api.getCheckHistory(url,param), callBack);
    }

    public void savePackagePhoto(String url, MultipartBody.Part part, IResponseCallBack callBack) {
        getObservable(api.savePackagePhoto(url, part), callBack);
    }

    public void requestCommend(String url, Map<String, String> param, IResponseCallBack callBack) {
        getObservable(api.requestCommend(url, param), callBack);
    }

    public void addMonitoringSite(Map<String, String> param, IResponseCallBack callBack) {
        addCommenParams(param);
        getObservable(api.addMonitoringSite(param), callBack);
    }

    public void addCorrection(Map<String, String> param, IResponseCallBack callBack) {
        addCommenParams(param);
        getObservable(api.addCorrection(param), callBack);
    }
